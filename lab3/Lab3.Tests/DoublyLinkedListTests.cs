...
public class DoublyLinkedListTests
{
    ...
    [Fact]
    public void Remove_FirstItem_ShouldRemoveCorrectly()
    {
        // Arrange
        var list = new DoublyLinkedList();
        list.Add(10);
    ...
    [Fact]
    public void Remove_LastItem_ShouldRemoveCorrectly()
    {
        // Arrange
        var list = new DoublyLinkedList();
        list.Add(10);
    ...
    [Fact]
    public void RemoveAt_FirstIndex_ShouldRemoveFirstItem()
    {
        // Arrange
        var list = new DoublyLinkedList();
        list.Add(10);
    ...
    [Fact]
    public void RemoveAt_LastIndex_ShouldRemoveLastItem()
    {
        // Arrange
        var list = new DoublyLinkedList();
        list.Add(10);
    ...
    [Fact]
    public void GetEnumerator_ModificationDuringEnumeration_ShouldThrowException()
    {
        // Arrange
        var list = new DoublyLinkedList();
        list.Add(10);
    ...
    [Fact]
    public void Indexer_Get_FromEnd_ShouldWorkCorrectly()
    {
        // Arrange
        var list = new DoublyLinkedList();
        for (int i = 0; i < 100; i++)
        ...
        Assert.Equal(50, list[50]);
    }

    [Fact]
    public void ComplexOperations_ShouldWorkCorrectly()
    {
        // Arrange
        var list = new DoublyLinkedList();
